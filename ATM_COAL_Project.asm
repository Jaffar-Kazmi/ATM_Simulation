...
.data
    ...
    withdraw_msg db 10, 13, " 2. Withdraw money$"
    deposit_msg DB 0AH, 0DH, " 3. Deposit money$"
    exit_msg db 10, 13, " 4. Exit$"
    ...
    ;Balance
    current_balance dw 10000  ; Initialize with a starting balance
...
.code
    main proc
        ...
        check_balance: 
            mov ah, 0h        ; Wait until a key is pressed
            int 16h
